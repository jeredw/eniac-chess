...
sim = Popen('./chsim/chsim c4.e', shell=True, stdin=PIPE, stdout=PIPE, stderr=DEVNULL)

# tell sim to start
sim.stdin.write('g\n'.encode())
sim.stdin.flush()
# XXX
# program prints board initially
...
while winner == 0:
  ...
  column = int(text)
  sim.stdin.write(f'{column:02}000\n'.encode())
  sim.stdin.flush()
  #sim.stdout.readline()  # ignore prompt
